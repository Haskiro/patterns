...
export const milk = new BeverageBasis('Молоко', 25);
export const coconutMilk = new BeverageBasis('Кокосовое молоко', 40);
export const almondMilk = new BeverageBasis('Миндальное молоко', 40);
